					...
					<div class="search">
						<form action="/searchBoard.ad" method="get" id="search">
							...
							<button id="write-btn" type="button">
								<a data-toggle="modal" data-target="#writeModal">글쓰기</a>
							</button>
							</td>
						</form>
					</div>
						...
						<div class="modal-content" id="modal-content">
							<div class="modal-body">
								...
								<form action="#" method="post" class="board-form">
									<center>
										<input type="submit" name="nodify" id="modify_submit"
											value="수정" />
										<button type="button" class="class" data-dismiss="modal"
											aria-label="Close" id="modify_cancle">닫기</button>
									</center>
								</form>
							</div>
						</div>
								...
								<div class="modal-body">
									<div id="guide-body">
										...
										<p class="guide_content">
											<textarea class="modal_input"></textarea>
										</p>
									</div>
									<form action="#" method="post" class="board-form">
									<center>
