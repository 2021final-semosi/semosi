...
<div class="page-wrapper">
	...
	<div class="body-container">
		...
		<div class="page-container">
			<form action="/faq_sitter_list.sms" class="form-inline" id="formSearch">
							...
							<c:choose>
								<c:when test="${fn:length(selectSFAQList)!=0 }">
									...
									<tr class="contents">
										...
										<div class="modal fade" id="modifyModal${status.index}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
											<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"	role="document">
												<div class="modal-content" id="modal-content">
													<form action="/faq_sitter_modify.sms" method="post" class="board-form">
														<div class="modal-body">
															<div id="guide-body">
																<input type="hidden" name="postNo" value="${selectSFAQList.postNo}"/>
																<p class="guide">제목</p>
																<p class="guide_text"><textarea class="modal_input" name="title">${selectSFAQList.title}</textarea></p>
																<br>
																<p class="guide">내용</p>
																<textarea class="guide_content" name="content">${selectSFAQList.content}</textarea>
															</div>
															<center>
										...
										<td class='date'>${selectSFAQList.writeDate}</td>
										
										<td class='del-YN'><c:choose>
											<c:when test="${selectSFAQList.delYn eq 'N'}">
												<button type="button" class="delete-btn delChangeFAQ" id="${selectSFAQList.postNo}" name="${selectSFAQList.delYn}">삭제</button>
											</c:when>
											<c:otherwise>
												<button type="button" class="restore-btn delChangeFAQ" id="${selectSFAQList.postNo}" name="${selectSFAQList.delYn}">복구</button>
											</c:otherwise>
										</c:choose>									
										</td>
									</tr>
			...
			<!-- 글 작성 -->
				<div class="modal fade" id="writeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
						<div class="modal-content" id="modal-content">
							<div class="modal-body">
								<form action="/faq_sitter_write.sms" method="post" class="board-form">
								<div id="guide-body">
									<p class="guide">제목</p>
