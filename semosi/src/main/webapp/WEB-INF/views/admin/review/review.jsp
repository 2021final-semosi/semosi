					...
					<div class="search">
						<form action="/searchBoard.ad" method="get" id="search">
							<select name="category">
								...
								<option value="sortofvoucher">아이디</option>
								<option value="voucherprice">이름</option>
								<option value="bought">후기 내용</option>
								<option value="enddate">후기 작성</option>
								<option value="refund-YN">삭제</option>
							</select>
					...
					<div class="tab-content">
						<table class="board">
							...
							<tr class="contents">
								...
								<td class='membername'>김농심</td>
								<td class='content'><a data-toggle="modal" data-target="#viewModal">아가들 짱 귀엽</a></td>
								<td class='date'></td>
								<td class='delete-YN'><button type="submit" class="delete-btn">삭제완료</button></td>
							</tr>
							<tr class="contents">
								<td class='select'><input type="checkbox" value="" name="send-select" /></td>
								<td class='post-no'></td>
								<td class='memberid'></td>
								<td class='membername'>백준</td>
								<td class='content'><a data-toggle="modal" data-target="#viewModal">후기</a></td>
								<td class='date'></td>
						...
						<div class="modal-content" id="modal-content">
					 		<div class="modal-body">
								<div>
									...
									<textarea class="guide_content" style="margin-top:30px;">후기 내용 들어와야한다고오오</textarea>
								</div>
								<center>
