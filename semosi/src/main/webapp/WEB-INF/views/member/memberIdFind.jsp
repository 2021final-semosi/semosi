...
<body>
	...
	<div class="container">
		...
		<div id="formArea">
			<center>
				<form name="memberIdSearch" action="/memberIdSearch.sms"
					method="post">
					...
					<div class="form-group row m-0">
						...
						<div class="col-sm-2 m-0 p-0">
							<span> <input type="button" id="sendSMSBtn" onclick="sendSMS();"
								...
								<input type="hidden" id="confirmPhone" value=""/>
							</span>
						</div>
					</div>
					...
					<div class="form-message row m-0">
						<label for="inputText" class="col-sm-4 message"></label> <span
							class="col-sm-8 message p-0" style="display: none;"
					...
					<script>
						...
						function totalCheck(){
							if($('#confirmPhone').val()=='true'){
								document.memberIdSearch.submit();
								return true;
							}else{
					...
					<br> <input type="button" id="submitBtn"
						class="btn btn-warning" onclick="totalCheck();" value="등록된 번호로 조회하여 아이디 찾기" />
				</form>
