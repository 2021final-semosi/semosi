...
.line {
	margin: 0px;	border: 5px solid #E1E1E1;
}
			...
			<div id="fixedNavi">
				...
				<div class="menu-main row m-0">
					...
					<div class="menu-svg col-3">
						...
						<svg xmlns="http://www.w3.org/2000/svg" id="icon-up" width="16"
							height="16" fill="currentColor" class="bi bi-chevron-up"
							viewBox="0 0 16 16"> <path fill-rule="evenodd"
				...
				<div class="menu-sub">
					<div class="hide">
						<a href="/sitterVoucherBuy.sms"><span>이용권 구매</span></a>
					</div>
					<div class="hide">
						<a href="/sitterVoucherPayView.sms"><span>이용권 조회</span></a>
					</div>
				</div>
