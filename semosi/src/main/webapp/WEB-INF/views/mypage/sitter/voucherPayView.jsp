<%@page import="kr.co.semosi.mypage.model.vo.SitterVoucher"%>
...
<%
	ArrayList<SitterVoucher> list = (ArrayList<SitterVoucher>)request.getAttribute("list");
...
<section id="wrapper">
	<div class="container">
		...
		%>
		<%for(SitterVoucher sv : list){ %>
		
		<div class="row p-0 m-0 line-content text-center">
			<div class="d-none d-md-block col-md-1 p-0 "><%=sv.getVoucherNo()%></div>
			<div class="d-none d-md-block col-md-2 p-0"><%=sm.getMemberId()%></div>
			<div class="col-3 col-md-3 p-0 "><%=sv.getVoucherName()%></div>
			<div class="col-3 col-md-2 p-0 "><%=sv.getVoucherPrice()%></div>
			<div class="col-3 col-md-2 p-0 "><%=sv.getBoughtDate()%></div>
			<div class="col-3 col-md-2 p-0 "><%=sv.getEndDate()%>
			</div>
		</div>
		<%} %>
