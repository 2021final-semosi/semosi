	...
	<div id="wrap">
		...
		<form id="info-table">
			<div class="input_info row">
				...
				<div class="col-md-10 col-sm-12">&nbsp; <span id="memberId"><%=pMember.getMemberId()%></span></div>
			</div>
			<div class="input_info row">
			...
			<div class="input_info row m-0">
						...
						<input type="text" class="form-control" id="phone" value="<%=pMember.getPhone()%>"
			...
			<div class="input_info row">
				...
				<div class="col-md-10 col-sm-12">
					<input type="text" class="form-control" id="sample6_address" name="address" value="<%=pMember.getAddress()%>" readonly>
