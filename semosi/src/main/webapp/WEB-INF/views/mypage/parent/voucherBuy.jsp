				...
				<form>
					<div class="voucher row m-0">
						<div class="col-sm-4 m-0 p-0">
							...
							<center>
								<input type="radio" name="voucherBuy" value="7days" >
							</center>
						</div>
						<div class="col-sm-4 m-0 p-0">
							<div class="voucherChoice">
							...
							<center>
								<input type="radio" name="voucherBuy" value="14days" checked>
							</center>
		...
		<center>
			...
			$(function(){			
				...
				$('#voucherPayBtn').click(function() {
				   var checkedVoucherType = $('input[name="voucherBuy"]:checked').val();
				   var voucherPrice ;
				   ...
				   function(rsp) {
				      if (rsp.success) {
				         var msg = '결제가 완료되었습니다.';//DB table에 저장 
				         $.ajax({
				            url: "/buyVoucherParent.sms",
