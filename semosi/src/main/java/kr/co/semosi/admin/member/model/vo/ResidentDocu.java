...
public ResidentDocu(int imageNo, String membersNo, String originalName, String changedName, String imagePath, Timestamp uploadTime, String delYn, String cretYn) {
    super();
    this.imageNo = imageNo;
    this.membersNo = membersNo;
    this.originalName = originalName;
